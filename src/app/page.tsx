...
const notes = {
  ...
  iHave: [
    ...
    "Chick-fil-A BOH ops: preparation, inventory, safety in fast-paced service.",
...
export default function Page() {
  return (
    <>
      ...
      <section aria-labelledby="highlights-title" id="highlights" className="py-12">
        <div className="mx-auto max-w-6xl px-4">
          <h2 id="highlights-title" className="mb-6 font-display text-3xl font-semibold">
            Highlights
          </h2>
        </div>
      ...
      <section aria-labelledby="connect-title" id="connect">
        <ConnectSection />
      </section>
