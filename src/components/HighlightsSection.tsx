...
const notes = {
  iAm: [
    ...
    "Builder shipping projects in Next.js, Python/pandas, and Tailwind/shadcn.",
  ...
  iHave: [
    "Case competition semi-finalist (P&G Fabric Care, Top 20 of 45 teams).",
    "Led 16+ beginner piano students through Faber curriculum.",
    "Interned in data analytics & data science roles across multiple orgs.",
